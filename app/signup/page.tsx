...
const SignUpPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        // Registration successful - redirect to sign in or show success message
        router.push('/signin?message=Registration successful! Please check your email to verify your account.');
      }
    } catch (error) {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-base text-gray-600 leading-relaxed">
              Join Booking.com to get the most out of your travels.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              <input
                ...
                className="mt-1 h-4 w-4 text-[#0071C2] focus:ring-[#0071C2] border-gray-300 rounded"
              />
          ...
          <div className="text-center mt-6">
            <p className="text-gray-600">
              ...
              <Link href="/signin" className="text-[#0071C2] hover:text-[#005A9E] hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </div>
